...
/**
 * Entry for Matisse'stroke media selection.
 */
public final class Matisse {
     ...
     * <p>
     * This Activity'stroke {@link Activity#onActivityResult(int, int, Intent)} will be called when user
     * finishes selecting.
     *
...
//                                            .imageEngine(new GlideEngine())
     ...
     * <p>
     * This Fragment'stroke {@link Fragment#onActivityResult(int, int, Intent)} will be called when user
     * finishes selecting.
     *
