...
public class GroupAllMembersAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        MyViewHolder holder;
        if (view == null) {
            view = LayoutInflater.from(TUIKit.getAppContext()).inflate(R.layout.group_all_member_adpater, viewGroup, false);
        ...
        if (!TextUtils.isEmpty(info.getIconUrl())){
            ...
            GlideEngine.loadImage(holder.memberIcon, R.drawable.default_user_image, null);
        }
