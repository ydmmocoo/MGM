...
public class GroupChatInfo extends BaseChatInfo {
    ...
    private List<TIMGroupMemberInfo> timGroupMemberInfos;
    ...
    public List<TIMGroupMemberInfo> getTimGroupMemberInfos() {
        return timGroupMemberInfos;
    }

    public void setTimGroupMemberInfos(List<TIMGroupMemberInfo> timGroupMemberInfos) {
        this.timGroupMemberInfos = timGroupMemberInfos;
    }
