...
public class WheelOptions<T> {
    ...
    public WheelOptions(View view, boolean isRestoreItem) {
        ...
        this.view = view;
        wv_option1 = (WheelView) view.findViewById(R.id.options_1);// 初始化时显示的数据
        wv_option2 = (WheelView) view.findViewById(R.id.options_2);
        wv_option3 = (WheelView) view.findViewById(R.id.options_3);
    }
