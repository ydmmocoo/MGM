 ...
 * Description：
 */
public class GroupModificationDialog extends DialogFragment {
    ...
    public static GroupModificationDialog getInstance(String title, String hint) {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(mEtContent.getText().toString())) {
                    ...
                    if (!TextUtils.isEmpty(hint)) {
                        ...
                        CommonToast.toast(R.string.please_modification_group_name);
                    }
                    return;
                }
