...
import com.tencent.qcloud.uikit.business.chat.group.view.widget.GroupAllMembersAdapter;
...
public class GroupMemberPanel extends LinearLayout implements IGroupMemberPanel {
    ...
    private void init() {
        ...
        mTitleBar.setTitle("全部群成员", PageTitleBar.POSITION.LEFT);
        ...
        mAdapter = new GroupAllMembersAdapter();
