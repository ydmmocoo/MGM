...
public class MessageInfo implements Serializable {
    ...
    /**
     * 同城(马岛服务)/新闻/黄页/名片分享到聊天
     */
    public static final int MSG_TYPE_NEARBY_CITY = 0x92;
    /**
     * 自定义类型消息--红包
     */
    public static final int MSG_TYPE_CUSTOM_RED_PACKET = 0x81;
    /**
     * 自定义类型消息--转账
     */
    public static final int MSG_TYPE_CUSTOM_TRANSFER = 0x85;
    /**
     * 自定义类型消息--转账
     */
    public static final int MSG_TYPE_CUSTOM_TRANSFER_TIP = 0x90;
    ...
    public static final int MSG_TYPE_GROUP_MODIFY_FACE_URL = 0x108;


    /**
     * 好友添加成功
     */
    public static final int MSG_TYPE_ADD_FRIEND_TIPS = 0x200;
