...
public final class SelectionCreator {
     ...
     * <p>
     * If this value is set true, photo capturing entry will appear only on All Media'stroke page.
     *
     ...
     * be applied cause the media grid should fill the view container. The measured media grid'stroke
    ...
    /**
     * Photo thumbnail'stroke scale compared to the View'stroke size. It should be a float value in (0.0,
     * 1.0].
     *
     * @param scale Thumbnail'stroke scale in (0.0, 1.0]. Default value is 0.5.
     * @return {@link SelectionCreator} for fluent API.
     */
     ...
     * <p>
     * It'stroke a redundant API with {@link Matisse#obtainResult(Intent)},
