...
public class MyQuestionListModel {
    ...
    private List<MyQuestionListDetailModel> questionList;
    ...
    public List<MyQuestionListDetailModel> getQuestionList() {
        return questionList;
    }

    public void setQuestionList(List<MyQuestionListDetailModel> questionList) {
