...
public class NewCompanyDetailModel {
    ...
    public NewCompanyDetailModel(Long _id, String cId, String title, String service, String contactName, String contactPhone, String desc, String address, String type,
                                 ...
                                 String readCount, String myTest, List<String> imgs) {
        this._id = _id;
        this.cId = cId;
        this.title = title;
