package com.library.repository.cache;
            ...
            if (request.body() instanceof FormBody) {
                ...
                if (body != null) {
                    for (int i = 0; i < body.size(); i++) {
                        if (TextUtils.equals(body.encodedName(i), "sign")
                                || TextUtils.equals(body.encodedName(i), "timestamp")
                        ) continue;
