...
public class NotifyUtil {
    ...
    public NotifyUtil(Context context, int ID) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            String channel_id = "mg_channel_1";
            String channel_description = "mg通知";
//            nm.deleteNotificationChannel(channel_id);
            //当sdk版本大于26
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
            NotificationChannel channel = new NotificationChannel(channel_id, channel_description, importance);
            channel.enableLights(true);
            channel.enableVibration(true);
            String uri = "android.resource://" + context.getPackageName() + "/" + R.raw.music_2;
            Uri no = Uri.parse(uri);
            channel.setSound(no, Notification.AUDIO_ATTRIBUTES_DEFAULT);
            nm.createNotificationChannel(channel);
            cBuilder = new Notification.Builder(mContext, channel_id);
...
//        String uri = "android.resource://" + ContextManager.getContext().getPackageName() + "/" + R.raw.music_1;
//        Uri no = Uri.parse(uri);
//        cBuilder.setSound(no);// 设置通知的提示音
...
//            defaults |= Notification.DEFAULT_SOUND;
            ...
            cBuilder.setSound(Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + mContext.getPackageName() + "/" + R.raw.music_2));
