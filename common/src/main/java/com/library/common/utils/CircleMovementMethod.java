...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = ContextManager.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = ContextManager.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
