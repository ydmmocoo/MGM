package com.library.common.pop;
...
public class SnsPopupWindow extends PopupWindow implements OnClickListener {
    ...
    public SnsPopupWindow(Context context, Boolean isMy) {
        ...
        delBtn.setText(isMy ? context.getString(R.string.delete) : context.getString(R.string.complaint));
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.digBtn) {
            ...
            mItemClickListener.onItemClick(mActionItems.get(1), 2);
        }
    }
