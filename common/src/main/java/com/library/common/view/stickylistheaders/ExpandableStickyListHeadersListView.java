...
public class ExpandableStickyListHeadersListView extends StickyListHeadersListView {
    ...
    ExpandableStickyListHeadersListView.IAnimationExecutor mDefaultAnimExecutor = new ExpandableStickyListHeadersListView.IAnimationExecutor() {
        @Override
        public void executeAnim(View target, int animType) {
    ...
    public void setAnimExecutor(ExpandableStickyListHeadersListView.IAnimationExecutor animExecutor) {
