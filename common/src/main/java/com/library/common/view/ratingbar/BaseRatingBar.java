package com.library.common.view.ratingbar;
...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            mEmptyDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.icon_start_empty);
        }

        if (mFilledDrawable == null) {
            mFilledDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.icon_start_filled);
        }
