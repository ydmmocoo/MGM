package com.library.common.view.stickylistheaders;
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mList.setLifeCycleListener(new StickyListHeadersListView.WrapperViewListLifeCycleListener());
        mList.setOnScrollListener(new StickyListHeadersListView.WrapperListScrollListener());
    ...
    public void setOnHeaderClickListener(StickyListHeadersListView.OnHeaderClickListener listener) {
        ...
        if (mAdapter != null) {
            if (mOnHeaderClickListener != null) {
                mAdapter.setOnHeaderClickListener(new StickyListHeadersListView.AdapterWrapperHeaderClickHandler());
    ...
    public void setAdapter(StickyListHeadersAdapter adapter) {
        ...
        mDataSetObserver = new StickyListHeadersListView.AdapterWrapperDataSetObserver();
