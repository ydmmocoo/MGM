package com.library.common.view.shortcutbadger.impl;
...
import com.library.common.view.shortcutbadger.Badger;
import com.library.common.view.shortcutbadger.ShortcutBadgeException;
import com.library.common.view.shortcutbadger.util.BroadcastHelper;
...
//         BroadcastHelper.sendDefaultIntentExplicitly(context, intent);
    ...
    private void executeBadgeByContentProvider(Context context, ComponentName componentName,
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            // We're in the main thread. Let'stroke ensure the badge update happens in a background
            ...
            // Already in a background thread. Let'stroke update the badge synchronously. Otherwise,
