...
import com.fjx.mg.nearbycity.mvp.NearbyCityCommentContract;
import com.fjx.mg.nearbycity.mvp.NearbyCityCommentPresenter;
import com.fjx.mg.news.comment.NewsReplyAdapter;
 ...
 * 同城评论列表item的详情页
 */
public class NearbyCityCommentActivity extends BaseMvpActivity<NearbyCityCommentPresenter> implements NearbyCityCommentContract.View {
    ...
    private NearbyCityCommentListModel commentListBean;
    ...
    public static Intent newInstance(Context context, String moddel) {
        Intent intent = new Intent(context, NearbyCityCommentActivity.class);
        intent.putExtra("model", moddel);
        return intent;
    }

    @Override
    protected NearbyCityCommentPresenter createPresenter() {
        return new NearbyCityCommentPresenter(this);
    }
    ...
    protected void initView() {
        ...
        commentListBean = JsonUtil.strToModel(model, NearbyCityCommentListModel.class);
...
//        refreshView.doRefresh();
    ...
    @Override
    public void showTopicDetail(NearbyCityCommentListModel model) {
        //显示顶部评论详情
    ...
    private void showCommentPop() {
        ...
        bottomEditPopu.setOnReplyListener(new BottomEditPopu.OnReplyListener() {
            ...
            public void onReply(String content) {
                popupView.dismiss();
                SoftInputUtil.hideSoftInput(NearbyCityCommentActivity.this);
