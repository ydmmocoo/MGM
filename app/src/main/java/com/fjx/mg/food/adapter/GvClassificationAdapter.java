...
public class GvClassificationAdapter extends BaseAdapter {
    ...
    public GvClassificationAdapter(Context context, List<ShopTypeBean.ShopTypeListBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_gv_classofication, null);
