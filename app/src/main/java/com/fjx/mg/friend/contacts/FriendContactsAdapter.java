...
public class FriendContactsAdapter extends BaseSectionQuickAdapter<FriendContactSectionModel, BaseViewHolder> {

    public FriendContactsAdapter(List<FriendContactSectionModel> data) {
