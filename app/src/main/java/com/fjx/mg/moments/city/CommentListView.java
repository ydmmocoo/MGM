...
public class CommentListView extends LinearLayout {
    ...
    private List<MomentsListBean.ListBean> mDatas;
    ...
    public void setDatas(List<MomentsListBean.ListBean> datas) {
        if (datas == null) {
            datas = new ArrayList<>();
        }
        mDatas = datas;
    ...
    public List<MomentsListBean.ListBean> getDatas() {
        return mDatas;
    }
    ...
    private View getView(final int position) {
        ...
        final MomentsListBean.ListBean bean = mDatas.get(position);
