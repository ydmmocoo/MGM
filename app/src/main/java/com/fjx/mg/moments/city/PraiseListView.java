...
public class PraiseListView extends TextView {
    ...
    private List<MomentsListBean.PraiseListBean> datas;
    ...
    public List<MomentsListBean.PraiseListBean> getDatas() {
        return datas;
    }

    public void setDatas(List<MomentsListBean.PraiseListBean> datas) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged() {
        ...
        if (datas != null && datas.size() > 0) {
            ...
            MomentsListBean.PraiseListBean item;
