 ...
 * @author yiw
 */
public class TypeMomentsCommentDialogx extends Dialog implements
    ...
    public TypeMomentsCommentDialogx(Context context, CityMomentsTypePresenterx presenter, String replyId, String content, boolean showDele) {
