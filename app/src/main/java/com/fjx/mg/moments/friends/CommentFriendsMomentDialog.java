 ...
 * @author yiw
 */
public class CommentFriendsMomentDialog extends Dialog implements
    ...
    public CommentFriendsMomentDialog(Context context, FriendsMomentsPresenter presenter, String replyId, String content, boolean showDele) {
