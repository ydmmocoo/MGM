 ...
 * @author yiw
 */
public class DetailMomentsCommentDialog extends Dialog implements
        View.OnClickListener {

    private MomentsDetailPresenter mPresenter;
    private Boolean showDele;
    private String replyId;
    private String content;

    public DetailMomentsCommentDialog(Context context, MomentsDetailPresenter presenter, String replyId, String content, boolean showDele) {
