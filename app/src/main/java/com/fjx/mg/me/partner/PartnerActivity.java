 ...
 * Describe:成为股东
 */
public class PartnerActivity extends BaseMvpActivity<PartnerPresenter> implements PartnerContract.IView {
    ...
    public static Intent newIntent(Context context) {
        return new Intent(context, PartnerActivity.class);
    }
    ...
    @Override
    protected PartnerPresenter createPresenter() {
...
//        webView.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ...
        mtvTitle.setText(getString(R.string.partner_system));
    }
