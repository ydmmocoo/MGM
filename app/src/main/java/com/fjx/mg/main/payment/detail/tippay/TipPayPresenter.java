...
class TipPayPresenter extends TipPayContract.Presenter {
    ...
    TipPayPresenter(TipPayContract.View view) {
        super(view);
    }
    ...
    void convertMoney(final Map<String, Object> payMap) {//换算接口
        ...
        RepositoryFactory.getRemoteRepository().convert("0", price)
    ...
    void phoneWxRecharge(final Map<String, Object> payMap) {//用微信支付赏金
        ...
        String rid = (String) payMap.get("rId");
        RepositoryFactory.getRemotePayRepository().rewardByWx(price, rid)
    ...
    void phoneZFBRecharge(final Map<String, Object> payMap) {//用支付宝支付赏金
        ...
        String price = (String) payMap.get("price");
        String rid = (String) payMap.get("rId");
        RepositoryFactory.getRemotePayRepository().rewardByAli(price, rid)
    ...
    void phoneBalanceRecharge(final Map<String, Object> payMap) {//用余额支付赏金
        ...
        String price = (String) payMap.get("price");
        String rid = (String) payMap.get("rId");
        RepositoryFactory.getRemotePayRepository().rewardByBalance(price, rid)
