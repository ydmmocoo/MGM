...
public class TipPayActivity extends BaseMvpActivity<TipPayPresenter> implements TipPayContract.View {
    ...
    public static Intent newInstance(Context context, String ext) {
        Intent intent = new Intent(context, TipPayActivity.class);
    ...
    @Override
    protected TipPayPresenter createPresenter() {
        return new TipPayPresenter(this);
    }
