...
public class YellowCommentActivity extends BaseMvpActivity<YellowCommentPresenter> implements YellowCommentContract.View {
    ...
    private YellowReplyAdapter replyAdapter;


    public static Intent newInstance(Context context, String moddel) {
        Intent intent = new Intent(context, YellowCommentActivity.class);
        intent.putExtra("model", moddel);
        return intent;
    }

    @Override
    protected YellowCommentPresenter createPresenter() {
        return new YellowCommentPresenter(this);
    }
    ...
    private void initRefresh() {
        ...
        replyAdapter = new YellowReplyAdapter();
        ...
        replyAdapter.setPraiseListenr(new YellowReplyAdapter.OnCLickPraiseListenr() {
            @Override
    ...
    private void showCommentPop() {
        ...
        bottomEditPopu.setOnReplyListener(new BottomEditPopu.OnReplyListener() {
            ...
            public void onReply(String content) {
                popupView.dismiss();
                SoftInputUtil.hideSoftInput(YellowCommentActivity.this);
